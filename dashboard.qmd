...
database = FileAttachment("https://zenodo.org/api/records/15215172/files/SINNO.UDIT.sqlite3/content").sqlite()
...
footer_left = d3.selectAll('.nav-footer-right')
    .append('p')
    .html('Explore the <a href="https://lite.datasette.io/?metadata=https://raw.githubusercontent.com/swinnoproject/datasette-lite/refs/heads/main/metadata.yml&url=https://zenodo.org/api/records/15215172/files/SINNO.UDIT.sqlite3/content">database interface</a> directly in your browser')
