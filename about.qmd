...
SWINNO data and meta data is publicly available (as far as privacy and copyright allows) as a spreadsheet that can be downloaded [here {{< bi arrow-up-right >}}](https://www.lusem.lu.se/economic-history/databases/swinno){target="_blank"}.
...
[publication details {{< bi arrow-up-right >}}](https://lup.lub.lu.se/search/publication/7868921){target="_blank"} [pdf {{< bi arrow-up-right >}}](https://lucris.lub.lu.se/ws/portalfiles/portal/5522430/7868934){target="_blank"}
